    ...
    <header className="fixed left-0 top-0 z-50 h-[82px] w-full border-b border-[#E5E5EA]/80 bg-white/95 shadow-[0_6px_18px_rgba(15,23,42,0.05)] backdrop-blur-sm">
      <nav className="mx-auto flex h-full w-full max-w-[1800px] items-center justify-between px-4 sm:px-6 lg:px-10">
        ...
        <div className="flex items-center gap-3 font-inter text-[13px] font-medium sm:gap-6 sm:text-[15px] lg:gap-8 lg:text-[16px]">
          <Link
            href="/"
            className={isActive("/") ? "border-b-[2px] border-[#BC0000] pb-[4px] font-semibold text-[#BC0000]" : "text-[#64748B] transition-colors hover:text-[#002B73]"}
          >
            Home
          </Link>
          ...
          <Link
            href="/shop"
            className={isActive("/shop") ? "border-b-[2px] border-[#BC0000] pb-[4px] font-semibold text-[#BC0000]" : "text-[#64748B] transition-colors hover:text-[#002B73]"}
          >
            Shop
          </Link>
          ...
          <Link
            href="/contact"
            className={isActive("/contact") ? "border-b-[2px] border-[#BC0000] pb-[4px] font-semibold text-[#BC0000]" : "text-[#64748B] transition-colors hover:text-[#002B73]"}
          >
            Contact
          </Link>
          ...
          <Link
            href="/price"
            className={isActive("/price") ? "border-b-[2px] border-[#BC0000] pb-[4px] font-semibold text-[#BC0000]" : "text-[#64748B] transition-colors hover:text-[#002B73]"}
          >
            Price
          </Link>
        </div>
